...
@Component(role = OidcAppCreator.class)
public class DefaultOidcAppCreator implements OidcAppCreator {

    @Override
    public ExtensibleResource createOidcApp(Client client, String oidcAppName) {
            ...
            Application app = client.instantiate(OpenIdConnectApplication.class)
                .setSettings(client.instantiate(OpenIdConnectApplicationSettings.class)
                    .setOAuthClient(client.instantiate(OpenIdConnectApplicationSettingsClient.class)
                        .setRedirectUris(Arrays.asList("http://localhost:8080/authorization-code/callback", // Okta Dev console defaults
                                                       "http://localhost:8080/login/oauth2/code/okta"))     // Spring Sec defaults
